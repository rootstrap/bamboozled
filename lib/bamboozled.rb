...
module Bamboozled
  class << self
    ...
    def client(subdomain: nil, api_key: nil, httparty_options: {}, api_url: nil)
      Bamboozled::Base.new(
        subdomain: subdomain, api_key: api_key, httparty_options: httparty_options, api_url: api_url
      )
    end
  end
end
